 ...
 */
;(function(a){var b=["","\u9009\u62e9\u5b66\u751f","\u9009\u62e9\u6559\u5e08","\u9009\u62e9\u5b66\u9662","\u9009\u62e9\u4e13\u4e1a","\u9009\u62e9\u73ed\u7ea7","\u9009\u62e9\u8bfe\u7a0b","\u9009\u62e9\u5e74\u7ea7","\u9009\u62e9\u673a\u6784","\u9009\u62e9\u4e8c\u7ea7\u6559\u5ba4\u573a\u5730\u7c7b\u522b","\u9009\u62e9\u89d2\u8272","\u9009\u62e9\u4e13\u4e1a\u65b9\u5411","\u9009\u62e9\u6559\u5b66\u573a\u5730","\u9009\u62E9\u5E74\u7EA7\u4E13\u4E1A","\u9009\u62e9\u7528\u6237","\u9009\u62e9\u5927\u7c7b","\u9009\u62E9\u8003\u8BD5\u540D\u79F0","\u9009\u62E9\u6559\u5B66\u73ED","\u9009\u62E9\u573A\u5730\u7C7B\u522B","\u9009\u62E9\u8BA1\u5212\u5185\u8BFE\u7A0B","\u9009\u62E9\u6821\u533A","\u9009\u62E9\u8BFE\u7A0B\u7EC4","\u9009\u62E9\u5E74\u7EA7\u5B66\u9662","\u9009\u62E9\u5F00\u8BFE\u5B66\u9662"];a.extend({showSelectDialog:function(d,e,c){var g={title:null,mapper:null,index:"select",checked:[],multiselect:true,selectAttr:true,width:800,height:500,gridType:d||"1"};c=(a.defined(c)&&jQuery.isFunction(c))?c:a.noop;a.extend(g,e||{});var h=e.title||(b[Number(g.gridType)]||"选择");var f=a.extend(true,{},g);a.dialog(a.extend({},g,{title:h,href:_path+"/grid/grid_cxCommonSelect.html",data:f,modalName:"selectModal",buttons:{success:{label:$.i18n.jwglxt["sure"],className:"btn-primary",callback:function(){return c.call(this,this.content.getResultArr(),this.content.getDeleteArr())}},cancel:{label:$.i18n.jwglxt["cancel"],className:"btn-default"}}}))}});a.fn.extend({loadSelectPanel:function(d,e,c){var f={title:null,href:"",mapper:null,index:"select",checked:[],multiselect:true,selectAttr:true,width:800,height:500,gridType:d||"1"};c=(a.defined(c)&&jQuery.isFunction(c))?c:a.noop;a.extend(f,e||{});window.api={data:f||{},opener:self};var g=f.title||(b[Number(f.gridType)-1]||"");a(this).load(_path+"/grid/grid_cxCommonSelect.html",a.extend(f,e||{},{title:g}),function(){c.call(this,getResultArr(),getDeleteArr())})}})}(jQuery));
/*
 * 业务框架工作流全局方法：详情参见：jquery.zftal.workflow-1.0.0.js
 */
;(function(a){a.hasWorkFlow=function(c){var b=false;jQuery.ajaxSetup({async:false});jQuery.post(_path+"/query/query_cxSpYwdmExist.html",{ywdm:c},function(d){b=d},"json");jQuery.ajaxSetup({async:true});return b};a.chooseWorkFlow=function(c,b){a.showDialog(_path+"/sp/spSetting_cxSelectBusiness.html",a.i18n.zftal.workFlow["chooseWorkFlow"],{width:"900px",modalName:"splModal",data:{ywdl:c},buttons:{success:{label:a.i18n.bootbox.buttons["success"],className:"btn-primary",callback:function(){if(a.isFunction(b)){return b.call(this)||false}else{return true}}},cancel:{label:a.i18n.bootbox.buttons["cancel"],className:"btn-primary"}}})};a.viewWorkFlow=function(b){a.showDialog(_path+"/sp/spSetting_cxLcgz.html",a.i18n.zftal.workFlow["viewWorkFlow"],a.extend(true,{},viewConfig,{width:"700px",data:{id:b}}))}})(jQuery);
/*
